...
<link rel="stylesheet" type="text/css" href="../css/skate.css" />
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Sport Extreme</a>
        </div>
    ...
    <div class="element">
      <h1> Skateboard Zone </h1>
<iframe width="720" height="400" src="https://www.youtube.com/embed/qk68G4GXN-k" frameborder="0" allowfullscreen></iframe>
    </div>

    <section>
        <article>
            <h1>Interview de la légende Californienne</h1>
        ...
        <aside>
           <h1>Nyjah Huston </h1>
            <p id="skateur"><img src="img/skate/skateur.jpg" alt="Photo de skateur" /></p>
            <p>Nyjah Huston (né le 30 novembre 1994) est un jeune skateboardeur venant de Davis, Californie, USA. Il a commencé le skate à 5 ans et est devenu professionel à 10 ans seulement.</p>
            <p>Ses sponsors sont Element Skateboards, Silver Trucks, FKD Bearings, Frontline Skatepark, et éS Footwear.</p>
